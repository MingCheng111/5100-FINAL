...
public abstract class Organization {
    ...
    public enum Type{
        ...
        BarAssignOrganization(" Bar Assign Organization"),
        BarCheerOrganization(" Bar Cheer Organization"),
        TicketSalesOrganizaiton("TicketSales Organizaiton"),
        AfterSalesOrganization("AfterSales Organization"),
        
        WorldCupFansOrganization("WorldCupFans Organization"),
        
        CheerAgencyOrganization("CheerAgencyOrganization"),
