...
public class GameManageWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(6, 105, 841, 187);
        ...
        btnAddNewConcert.setBounds(6, 322, 162, 29);
        ...
        add(btnAccept);
        btnAccept.setBounds(522, 322, 134, 29);
        ...
        btnChooseStadium.setBounds(261, 322, 158, 29);
        ...
        add(txtTicketPrice);
        txtTicketPrice.setBounds(6, 380, 162, 27);
