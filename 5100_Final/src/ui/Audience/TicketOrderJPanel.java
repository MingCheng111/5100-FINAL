...
public class TicketOrderJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(6, 156, 810, 139);

        jLabel1.setFont(new java.awt.Font("Bodoni MT", 1, 24)); // NOI18N
        jLabel1.setText("Tickets Order History");
        add(jLabel1);
        jLabel1.setBounds(236, 108, 270, 30);
        add(jSeparator1);
        jSeparator1.setBounds(0, 55, 849, 11);
        ...
        add(btnComplete);
        btnComplete.setBounds(531, 307, 131, 29);

        lblPrice.setFont(new java.awt.Font("Bodoni MT", 0, 14)); // NOI18N
        lblPrice.setText(" ");
        add(lblPrice);
        lblPrice.setBounds(177, 615, 80, 17);
        ...
        add(btnBuyTicket);
        btnBuyTicket.setBounds(691, 523, 125, 29);
        ...
        add(jScrollPane2);
        jScrollPane2.setBounds(6, 372, 810, 139);
